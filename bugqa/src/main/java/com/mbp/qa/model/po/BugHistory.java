...
public class BugHistory implements Serializable {
	 ...
	 * 対応開始日付
	 */
	private Date plnStartDate;

	/**
	 * 対応終了日付
	 */
	private Date plnEndDate;
	...
	public Date getPlnStartDate() {
		return plnStartDate;
	}

	public void setPlnStartDate(Date plnStartDate) {
		this.plnStartDate = plnStartDate;
	}

	public Date getPlnEndDate() {
		return plnEndDate;
	}

	public void setPlnEndDate(Date plnEndDate) {
		this.plnEndDate = plnEndDate;
	}
