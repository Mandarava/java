...
<body>
	<s:form id="myform" action="Clear" namespace="/" method="post">
		<table border="0"
			style="width: 77%; table-layout: fixed; margin-left: 2%">
			<colgroup>
				<col style="width: 7%" />
				<col style="width: 7%" />
				<col style="width: 7%" />
			...
			<tr>
				...
				<td colspan=5>&nbsp;&nbsp;<input type="radio"
					...
					value="2">部门别 + 职务级别 年收合计
				</td>
			</tr>
			<tr>
				<td colspan=2>&nbsp;&nbsp;请点击:</td>
				<td colspan=1 align="left"><button type="button"
						style="width: 90%" onclick = "selectDeptInfo();">检索</button></td>
				<td colspan=1 align="center"><button type="button"
						style="width: 90%" onclick = "clearView();">清空</button></td>
				<td colspan=1 align="right"><button type="button"
						style="width: 90%" onclick = "exit();">退出</button></td>
				<td colspan=1></td>
				<td colspan=5>&nbsp;&nbsp;<input type="radio"
					name="deptInfo.memSelKey.searchCondition"
		...
		<br>
		<table border="1"
			style="width: 70%; table-layout: fixed; margin-left: 2%">
			<colgroup>
				<col style="width: 7%" />
				<col style="width: 7%" />
				<col style="width: 7%" />
