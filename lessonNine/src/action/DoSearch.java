...
public class DoSearch extends ActionSupport {
	...
	/** 总的dataBean */
	private SearchDatabean pageBean;
	 ...
	 * @return 总的dataBean
	 */
	public SearchDatabean getPageBean() {
		return pageBean;
	}
	 ...
	 *            总的dataBean
	 */
	public void setPageBean(SearchDatabean pageBean) {
	...
	public String doSelect() {
		...
		/** 保存查找到的一览数据 结果集 */
//		List<SearchDataDatabean> modelList = new SearchService()
